...
values
  ...
  ('468ab4e8-1cfc-57f9-b858-58bacb62a536', 'letsbe-mild', '롯데칠성', 'lotte', '레쓰비 마일드', 'coffee', '1캔 175 mL', 175, 74, 14, 60, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','캔커피','레쓰비','마일드','RTD']::text[], 'approved'),
  ('1b3e34db-8950-5357-938b-b3e7a5d17cc6', 'cantata-premium-latte', '롯데칠성', 'lotte', '칸타타 프리미엄 라떼', 'coffee', '1캔 275 mL', 275, 138, 24, 125, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','캔커피','칸타타','라떼','RTD']::text[], 'approved'),
  ('03908274-2a11-5fbe-84c9-2ff1845b91c4', 'georgia-original', '코카콜라', 'cocacola', '조지아 오리지널', 'coffee', '1캔 240 mL', 240, 126, 18, 94, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','캔커피','조지아','오리지널','RTD']::text[], 'approved'),
  ('eb827eae-36d3-54f4-ba13-4f512ab2bba8', 'georgia-craft-black', '코카콜라', 'cocacola', '조지아 크래프트 블랙', 'coffee', '1병 470 mL', 470, 188, 0, 12, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','페트','조지아','크래프트','아메리카노','블랙','RTD']::text[], 'approved'),
  ('90d5c22e-8cc3-5e9d-90cb-3fc6cf583359', 'georgia-craft-latte', '코카콜라', 'cocacola', '조지아 크래프트 카페라떼', 'coffee', '1병 470 mL', 470, 229, null, null, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','페트','조지아','크래프트','라떼','RTD']::text[], 'approved'),
  ('833f1b99-61d6-5e06-8d2d-aa6930839747', 'maxim-top-master-latte', '동서식품', 'dongsuh', '맥심 티오피 마스터 라떼', 'coffee', '1캔 275 mL', 275, 94, null, 109, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','캔커피','맥심','티오피','TOP','라떼','RTD']::text[], 'approved'),
  ('4bbf4ad5-2653-5ce8-8246-c32776241320', 'maxim-top-the-black', '동서식품', 'dongsuh', '맥심 티오피 더 블랙', 'coffee', '1캔 275 mL', 275, 150, 0, null, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','캔커피','맥심','티오피','TOP','블랙','아메리카노','RTD']::text[], 'approved'),
  ('3b182310-9fed-572b-b3de-ceef55fc1444', 'sb-rtd-doubleshot-espresso-cream', '스타벅스 RTD', 'starbucks-rtd', '스타벅스 더블샷 에스프레소 & 크림', 'coffee', '1캔 200 mL', 200, 132, 20, 115, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','캔커피','스타벅스','더블샷','에스프레소','RTD']::text[], 'approved'),
  ('5196b9fe-f36c-5319-b43f-b62a0ad98e88', 'sb-rtd-frappuccino-mocha', '스타벅스 RTD', 'starbucks-rtd', '스타벅스 프라푸치노 모카 (병)', 'coffee', '1병 281 mL', 281, 110, 30, 175, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','병커피','스타벅스','프라푸치노','모카','RTD']::text[], 'approved'),
  ('ab33bb11-9ba8-5c9f-a778-7c03ed4c4a0e', 'sb-rtd-cold-brew-black', '스타벅스 RTD', 'starbucks-rtd', '스타벅스 콜드 브루 블랙 (컵)', 'coffee', '1컵 325 mL', 325, 167, 0, null, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','컵커피','스타벅스','콜드브루','콜드 브루','블랙','RTD']::text[], 'approved'),
  ('afca3bbf-e2ea-5eda-bea4-1828c89fa49c', 'cu-get-ice-americano-xl', 'CU GET커피', 'cu', 'GET 아이스 아메리카노 XL', 'coffee', 'XL 525 mL', 525, 240, 0, null, null, '기록 시 결제액을 입력하세요', null, 'CU 보도자료(2024)', null, array['편의점','CU','GET','겟커피','아메리카노','아이스','원두커피']::text[], 'approved'),
  ('d51e16c7-c4cb-5dee-89fd-c2579c69bdcc', 'cu-get-cafe-latte', 'CU GET커피', 'cu', 'GET 카페라떼', 'coffee', '1컵 280 mL', 280, 95, 22, 186, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','CU','GET','겟커피','라떼','원두커피']::text[], 'approved'),
  ('0e9b2145-7ca5-5523-9542-e00067f3182c', 'gs25-cafe25-americano-m', 'GS25 카페25', 'gs25', '카페25 아메리카노 (M · 1샷)', 'coffee', 'M 1샷', null, 137, 0, null, null, '기록 시 결제액을 입력하세요', null, 'GS25 앱 영양정보(이용자 제보)', null, array['편의점','GS25','카페25','cafe25','아메리카노','원두커피']::text[], 'approved'),
  ('eac5a160-5113-5e9b-bc86-7d161c92f013', 'gs25-cafe25-cafe-latte', 'GS25 카페25', 'gs25', '카페25 카페라떼', 'coffee', '1컵 230 mL', 230, 75, 25, 135, null, '기록 시 결제액을 입력하세요', null, '제품 표시사항', null, array['편의점','GS25','카페25','cafe25','라떼','원두커피']::text[], 'approved')
